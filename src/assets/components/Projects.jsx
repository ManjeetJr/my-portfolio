      ...
      <div style={styles.inner}>
        ...
        >
          ...
          <h2 style={styles.sectionTitle}>
            <span style={styles.titleAccent}>Projects</span>
          </h2>
...
const styles = {
  ...
  sectionSub: {
    ...
    fontSize: "clamp(13px, 1.8vw, 15px)", color: GOLDF + "0.5)", margin: 0,
  },
  ...
  /* Image */
  imgWrap:    { position: "relative", height: "clamp(160px, 25vw, 220px)", overflow: "hidden", flexShrink: 0 },
  ...
  difficultyStars: { fontSize: "11px", color: GOLD, letterSpacing: "2px" },

  /* Content */
  content: {
    padding: "clamp(14px, 3vw, 22px) clamp(14px, 3vw, 24px) clamp(16px, 3vw, 24px)",
  ...
  title: {
    ...
    color: "#e8d5a3", margin: 0, lineHeight: 1.3, letterSpacing: "0.5px",
  },
  desc: {
    fontFamily: "'Lato', sans-serif", fontWeight: 300,
    fontSize: "clamp(12px, 1.8vw, 13.5px)",
    color: "rgba(220,200,160,0.65)", margin: 0, lineHeight: 1.75,
  },
  ...
  infoVal:  { fontFamily: "'Lato', sans-serif", fontSize: "clamp(11px, 1.8vw, 12.5px)", color: "rgba(220,200,160,0.75)", margin: 0 },
  ...
  footerCtaText: {
    fontFamily: "'Lato', sans-serif", fontWeight: 300,
    fontSize: "14px", color: GOLDF + "0.5)", margin: 0, letterSpacing: "1px",
  },
  githubBtn: {
    ...
    borderRadius: "4px", boxShadow: `0 4px 24px ${GOLDF}0.3)`,
  },
};